...
export function HeroSlider() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(160deg, #021a11 0%, #064e3b 100%)",
      }}
    >
      {/* Motif points */}
      <div
      ...
      <div className="relative z-2 mx-auto flex w-full max-w-12xl flex-1 items-center px-8 pb-20 pt-28 sm:px-12 lg:px-16">
        <div className="flex flex-col" style={{ width: "40%", minWidth: "" }}>
          ...
          <div className="mt-16 flex flex-wrap gap-3">
            <Link
              to="/login"
              className="rounded-sm bg-emerald-500 px-2 py-2.5 text-xs font-bold uppercase tracking-widest text-white transition hover:bg-emerald-400"
            >
