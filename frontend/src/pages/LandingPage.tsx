...
const STATS = [
  {
    value: 'Multi-organisation',
    label: 'Une plateforme, vos élections',
    sub: 'Chaque organisation gère ses propres scrutins',
    icon: (
  ...
  },
  {
    ...
    sub: 'À la connexion et à la confirmation du vote',
    icon: (
      <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
          ...
          >
            <div className="flex flex-col items-center gap-6 px-10 py-16 text-center sm:px-14">
              <h2 className="text-2xl font-extrabold text-white sm:text-3xl">
                Votre organisation, votre élection
              </h2>
              <p className="max-w-md text-sm font-medium text-emerald-200">
                Connectez-vous à votre espace membre pour suivre vos élections en cours.
              </p>
              <Link
                to="/login"
      ...
      <footer className="border-t border-ink-100 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-8 sm:flex-row sm:px-6">
          ...
          <p className="text-sm text-ink-400">
            © {new Date().getFullYear()} eVote — Plateforme de vote électronique
          </p>
